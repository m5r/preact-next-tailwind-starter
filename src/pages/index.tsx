				...
				<div className="max-w-screen-xl mx-auto px-4 sm:px-6">
					<nav className="relative flex items-center justify-between sm:h-10 md:justify-center">
						...
						<div className="hidden md:flex md:space-x-10">
							...
							<a href="#"
							   className="font-medium text-gray-500 hover:text-gray-900 transition duration-150 ease-in-out">Marketplace</a>
							<a href="#"
							   className="font-medium text-gray-500 hover:text-gray-900 transition duration-150 ease-in-out">Company</a>
						</div>
						<div
				...
				<main className="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 xl:mt-28">
					<div className="text-center">
						<h2 className="text-4xl tracking-tight leading-10 font-extrabold text-gray-900 sm:text-5xl sm:leading-none md:text-6xl">
							Pecah is your next <br /> <span
							className="text-indigo-600">serverless web application</span> <br /> boilerplate
						</h2>
					...
					<div className="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
						<div className="rounded-lg shadow-md">
							<div className="rounded-lg bg-white shadow-xs overflow-hidden" role="menu"
								...
								<div className="px-5 pt-4 flex items-center justify-between">
									<div>
										<img className="h-8 w-auto" src="/img/logos/workflow-mark-on-white.svg"
											 alt="" />
									</div>
									<div className="-mr-2">
										<button type="button"
				...
				<div
					...
					<div className="md:flex-shrink-0">
						<svg fill="none" height="40" viewBox="0 0 105 40" role="img" aria-labelledby="svg-tuple">
							...
							<path fill="#B4C6FC" fillRule="evenodd"
			...
			<div
				...
				<div className="mt-8 md:mt-0 md:order-1">
					<p className="text-center text-base leading-6 text-gray-400">
						&copy; <a href="https://www.capsulecorp.dev" target="_blank" rel="noopener noreferrer">Capsule Corp.</a>
					</p>
				</div>
			</div>
		</div>
